...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Clear error states on input focus/type
        ...
        contactForm.addEventListener('submit', (e) => {
            ...
            if (isFormValid) {
                ...
                setTimeout(() => {
                    ...
                    // Show success banner
                    if (successAlert) {
                        successAlert.classList.remove('success-alert-hidden');
                        successAlert.style.animation = 'zoomIn 0.3s ease-out';
                        ...
                        setTimeout(() => {
                            successAlert.classList.add('success-alert-hidden');
                        }, 6000);
                    }
